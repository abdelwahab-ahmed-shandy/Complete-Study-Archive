...
namespace Quick_Tickets.Migrations
{
    ...
    [Migration("20250226215243_EditTablethePhoto")]
    partial class EditTablethePhoto
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Quick_Tickets.Models.Movie", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            EndDate = new DateTime(2025, 3, 26, 23, 52, 42, 762, DateTimeKind.Local).AddTicks(7518),
                            ImgUrl = "naruto.jpg",
                            MovieStatus = 1,
                            Name = "Naruto: The Last",
                            Price = 12.99,
                            StartDate = new DateTime(2025, 2, 26, 23, 52, 42, 762, DateTimeKind.Local).AddTicks(7473),
                        ...
                        new
                        {
                            ...
                            EndDate = new DateTime(2025, 3, 26, 23, 52, 42, 762, DateTimeKind.Local).AddTicks(7526),
                            ImgUrl = "johnwick.jpg",
                            MovieStatus = 1,
                            Name = "John Wick",
                            Price = 15.99,
                            StartDate = new DateTime(2025, 2, 26, 23, 52, 42, 762, DateTimeKind.Local).AddTicks(7525),
                        ...
                        new
                        {
                            ...
                            EndDate = new DateTime(2025, 3, 26, 23, 52, 42, 762, DateTimeKind.Local).AddTicks(7531),
                            ImgUrl = "conjuring.jpg",
                            MovieStatus = 1,
                            Name = "The Conjuring",
                            Price = 10.99,
                            StartDate = new DateTime(2025, 2, 26, 23, 52, 42, 762, DateTimeKind.Local).AddTicks(7529),
