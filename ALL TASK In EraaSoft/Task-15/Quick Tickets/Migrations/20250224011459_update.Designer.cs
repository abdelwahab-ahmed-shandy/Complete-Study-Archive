...
namespace Quick_Tickets.Migrations
{
    ...
    [Migration("20250224011459_update")]
            ...
            modelBuilder.Entity("Quick_Tickets.Models.Movie", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            EndDate = new DateTime(2025, 3, 24, 3, 14, 59, 104, DateTimeKind.Local).AddTicks(883),
                            ImgUrl = "naruto.jpg",
                            MovieStatus = 1,
                            Name = "Naruto: The Last",
                            Price = 12.99,
                            StartDate = new DateTime(2025, 2, 24, 3, 14, 59, 104, DateTimeKind.Local).AddTicks(840),
                        ...
                        new
                        {
                            ...
                            EndDate = new DateTime(2025, 3, 24, 3, 14, 59, 104, DateTimeKind.Local).AddTicks(891),
                            ImgUrl = "johnwick.jpg",
                            MovieStatus = 1,
                            Name = "John Wick",
                            Price = 15.99,
                            StartDate = new DateTime(2025, 2, 24, 3, 14, 59, 104, DateTimeKind.Local).AddTicks(889),
                        ...
                        new
                        {
                            ...
                            EndDate = new DateTime(2025, 3, 24, 3, 14, 59, 104, DateTimeKind.Local).AddTicks(895),
                            ImgUrl = "conjuring.jpg",
                            MovieStatus = 1,
                            Name = "The Conjuring",
                            Price = 10.99,
                            StartDate = new DateTime(2025, 2, 24, 3, 14, 59, 104, DateTimeKind.Local).AddTicks(894),
