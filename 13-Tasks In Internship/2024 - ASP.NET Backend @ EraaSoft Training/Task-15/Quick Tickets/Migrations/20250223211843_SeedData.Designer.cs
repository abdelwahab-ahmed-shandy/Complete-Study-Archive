...
namespace Quick_Tickets.Migrations
{
    ...
    [Migration("20250223211843_SeedData")]
            ...
            modelBuilder.Entity("Quick_Tickets.Models.Movie", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            EndDate = new DateTime(2025, 3, 23, 23, 18, 42, 796, DateTimeKind.Local).AddTicks(4673),
                            ImgUrl = "naruto.jpg",
                            MovieStatus = 1,
                            Name = "Naruto: The Last",
                            Price = 12.99,
                            StartDate = new DateTime(2025, 2, 23, 23, 18, 42, 796, DateTimeKind.Local).AddTicks(4618),
                        ...
                        new
                        {
                            ...
                            EndDate = new DateTime(2025, 3, 23, 23, 18, 42, 796, DateTimeKind.Local).AddTicks(4684),
                            ImgUrl = "johnwick.jpg",
                            MovieStatus = 1,
                            Name = "John Wick",
                            Price = 15.99,
                            StartDate = new DateTime(2025, 2, 23, 23, 18, 42, 796, DateTimeKind.Local).AddTicks(4682),
                        ...
                        new
                        {
                            ...
                            EndDate = new DateTime(2025, 3, 23, 23, 18, 42, 796, DateTimeKind.Local).AddTicks(4691),
                            ImgUrl = "conjuring.jpg",
                            MovieStatus = 1,
                            Name = "The Conjuring",
                            Price = 10.99,
                            StartDate = new DateTime(2025, 2, 23, 23, 18, 42, 796, DateTimeKind.Local).AddTicks(4689),
